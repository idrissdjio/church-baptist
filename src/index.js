  ...
  <BrowserRouter>
    <SBC>
      <Routes>
        ...
        <Route path="/consent" element={() => { window.location.href = 'https://forms.gle/Uu21ADNG8Ddznm7DA'; return null; }} />
        <Route path="/hbc" element={() => { window.location.href = 'https://forms.gle/sLyqc8vLZdAYhsAh8'; return null; }} />
        <Route path="/s4c" element={() => { window.location.href = 'https://forms.gle/LGJWhhwdfzdz8joW8'; return null; }} />
